...
float g=0,g1=0;   // car  translate indicator
...
;
	...
	glBegin(GL_POLYGON);
		...
		glVertex2f(900.0-k,880.0+n); //base2
		glVertex2f(900.0-k,900.0+n);
		glVertex2f(500.0,900.0);
	glEnd();
	...
	glBegin(GL_POLYGON);
		...
		glVertex2f(1300.0,880.0);	// base 3
...
void boat()
{
	...
	glBegin(GL_POLYGON);
		glColor3f(0.0,0.0,0.0);     // boat back  1
	...
	glBegin(GL_POLYGON);
		glColor3f(0.0,0.0,0.0);
		glVertex2f(901.0,0.0);      //boat back  2
		glVertex2f(1050.0,200.0);
...
glTranslatef(g,0,0);
	...
	glBegin(GL_POLYGON);                  //  car
		...
		glVertex2f(2100.0,1050.0);
		glVertex2f(2250.0,1050.0);
		glVertex2f(2250.0,1150.0);
		glVertex2f(2100.0,1150.0);
	glEnd();


	glBegin(GL_POLYGON);                  //  car
		glColor3f(0.0,0.0,0.0);
		glVertex2f(2070.0,1030.0);
		glVertex2f(2100.0,1050.0);
		glVertex2f(2100.0,1150.0);
		glVertex2f(2070.0,1130.0);
	glEnd();
    ...
    glBegin(GL_LINES);
		glColor3f(0.0,0.0,0.0);
		glVertex2f(2120.0,1080.0);
		glVertex2f(2220.0,1080.0);
		glVertex2f(2220.0,1080.0);
		glVertex2f(2220.0,1110.0);
		glVertex2f(2220.0,1110.0);             //carrier
		glVertex2f(2220.0,1110.0);
		glVertex2f(2120.0,1110.0);
		glVertex2f(2120.0,1080.0);
		glVertex2f(2140.0,1080.0);
		glVertex2f(2140.0,1110.0);
		glVertex2f(2160.0,1080.0);
		glVertex2f(2160.0,1110.0);
		glVertex2f(2180.0,1080.0);
		glVertex2f(2180.0,1110.0);
		glVertex2f(2200.0,1080.0);
		glVertex2f(2200.0,1110.0);
	glEnd();


	glBegin(GL_LINES);
		glColor3f(1.0,0.0,1.0);
		glVertex2f(2080.0,1035.0);        //head lamp
		glVertex2f(2080.0,1045.0);
	glEnd();


	glBegin(GL_LINES);
		glColor3f(1.0,0.0,1.0);
		glVertex2f(2080.0,1125.0);        //head lamp
		glVertex2f(2080.0,1135.0);
	glEnd();


	glBegin(GL_LINES);
		glColor3f(1.0,0.0,1.0);
		glVertex2f(2090.0,1055.0);        //horn grill
		glVertex2f(2090.0,1125.0);
		glEnd();


	glBegin(GL_LINES);
		glColor3f(1.0,0.0,1.0);
		glVertex2f(2100.0,1040.0);        //side window
		glVertex2f(2230.0,1040.0);
		glEnd();
